%% supplemental material, demo6 MUA
% =========================================================================
%
% Demo of example 4 (Urban image) of the paper:
% 
...
% HERE YOU NEED TO LOAD THE URBAN IMAGE FILE.
addpath('real_data')
load('Urban_R162.mat')
...
load('spectral_library_urban.mat')
n = size(A,2);
...
[ha, pos] = tight_subplot(6,4,[.01 .01],[.05 .05],[.05 .15]);
...
axes(ha((1-1)*numAlgs + 1)); ylabel('Asphalt','interpreter','latex')
...
mkdir('examples')
print('examples/estim_abundances_urban','-dpdf')


figure, imagesc(1.7*Yim(:,:,[100 60 40]))
set(gca,'xtick',[]), set(gca,'xticklabel',[]), set(gca,'ytick',[]), set(gca,'yticklabel',[])
print('examples/urban_im','-dpdf')
